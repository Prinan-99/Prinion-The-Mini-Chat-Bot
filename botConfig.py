...
myBotName = "Prinion The Mini Chat Bot"
botTimeZone = "Asia/Kolkata"  ##See the list full below
botAvatar = "/static/bgminion.png" ##This can either be an image in your static folder or a web url to an image
chatBG = "/static/bgyellow.jpg"  ##This can either be an image in your static folder or a web url to an image
